...
|---|---|---|---|
| P1-06 scope governance (#43) | 2026-09-11 | `docs/43-p1-06-governance` | Authorized Decision Log amendment; document verification complete; independent review pending; implementation remains paused until governance is complete |
