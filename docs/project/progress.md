...
| Correct stale requirements.txt header descriptions (#32) | 2026-08-24 | `docs/32-correct-requirements-header-descriptions` | Replaced three stale custom-header claims with pip-compile native-header wording, assigned future CI drift enforcement to P1-07, removed the completed P1-04 future-tense lock note, preserved `backend/requirements.txt` byte-for-byte, and preserved the P1-05 `pydantic.mypy` obligation; documentation/history checks and Phase 0 manifest 10/10 passed |
