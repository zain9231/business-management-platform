...
generated, fully pinned export with pip-compile's native autogenerated header. Regenerate it with
`pip-compile --output-file=requirements.txt pyproject.toml` whenever dependencies change; never
hand-edit it or let the two lists diverge. P1-07 owns CI drift enforcement.
